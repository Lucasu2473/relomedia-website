  ...
  return (
    <main className="blank-page" aria-label="ReloMedia homepage">
      ...
      <section className="hero">
        ...
        <section className="primelife-showcase" aria-label="Additional DRTRACK program screenshots">
          <div className="primelife-phone-row">
            <img src="/demos/drtrack-profit.png" alt="DRTRACK profit dashboard" />
            <img src="/demos/drtrack-social-realtime.png" alt="DRTRACK social media realtime dashboard" />
            <img src="/demos/drtrack-sales-dashboard-new.png" alt="DRTRACK sales dashboard" />
          </div>
        </section>
        ...
        <section className="testimonials-section" aria-label="Testimonials">
          ...
          <div className="testimonial-frame">
            <iframe
              src="https://www.youtube.com/embed/uuK83fIgrFM"
